                            ...
                            <div class="left_title_nav">
                                <div class="left_title_nav_inner">
                                    <div class="left_title_nav_link_block">
                                        <a href="/news" class="left_title_nav_link active">Все новости</a>
                                    </div>
                                    <?php foreach($cats as $cat): ?>
                                        <div class="left_title_nav_link_block">
                                            <a href="news/category/<?=$cat->alias;?>" class="left_title_nav_link"><?=$cat->title;?></a>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                                ...
                                <div class="left_title_nav_mobile_wrapper">
                                    <div class="left_title_nav_mobile_inner">
                                        <div class="left_title_nav_mobile_link_block">
                                            <a href="/news" class="left_title_nav_mobile_link active">Все новости</a>
                                        </div>
                                        <?php foreach($cats as $cat): ?>
                                            <div class="left_title_nav_mobile_link_block">
                                                <a href="/news/category/<?=$cat->alias;?>" class="left_title_nav_mobile_link"><?=$cat->title;?>
                                                </a>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                ...
                                <div id="articles_page" class="articles_item_block">
                                    <?php foreach ($articlesDesktop as $articleDesktop): ?>
                                        ...
                                        <div class="articles_item">
                                            <a href='news/<?=$articleDesktop->alias;?>' class="articles_item_inner">
                                                <!--Content-->
                                                <div class="articles_item_content">
                                                    ...
                                                    <div class="articles_item_content_left">
                                                        ...
                                                        <div class="articles_item_text">
                                                            <?=$articleDesktop->preview_text;?>
                                                        </div>
                                                    </div>
                                                    <!--Right-->
                                                    <div class="articles_item_content_right">
                                                        <!--Background-->
                                                        <div class="articles_item_bg" style="background-image: url('/public/images/news/bg/desktop/<?=$articleDesktop->image;?>');">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--Footer-->
