...
<head>
    ...
    <!--Connect Styles-->
    <link rel="stylesheet" href="/errors/prod/css/style.css">
...
<div class="error_page">
    ...
    <div class="main_content_error">
        <div class="container">
            <div class="main_content_error_inner">
                <!--Background-->
                <div class="main_content_error_background">
                    ERROR
                </div>
                <!--Title-->
                <div class="main_content_error_title">
                    Произошла какая-то ошибка
                </div>
                <!--Text-->
                <div class="main_content_error_text">
                    По непонятным причинам браузер не смог загрузить сайт. Попробуйте обновить страницу через какое-то время.
                </div>
                <!--Footer-->
                <div class="main_content_error_footer">
                    <!--Link-->
                    <a href="<?=PATH;?>" class="main_content_error_footer_link" tabindex="-2">
                        Перейти на главную
                        <!--Svg-->
                        <svg class="main_content_error_footer_link_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g id="simple-link-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><path d="M19.5857864,11 L17.2928932,8.70710678 C16.9023689,8.31658249 16.9023689,7.68341751 17.2928932,7.29289322 C17.6834175,6.90236893 18.3165825,6.90236893 18.7071068,7.29289322 L22.7071068,11.2928932 C23.0976311,11.6834175 23.0976311,12.3165825 22.7071068,12.7071068 L18.7071068,16.7071068 C18.3165825,17.0976311 17.6834175,17.0976311 17.2928932,16.7071068 C16.9023689,16.3165825 16.9023689,15.6834175 17.2928932,15.2928932 L19.5857864,13 L2,13 C1.44771525,13 1,12.5522847 1,12 C1,11.4477153 1.44771525,11 2,11 L19.5857864,11 Z" id="Combined-Shape" fill="#2da98c" fill-rule="nonzero"></path></g></svg>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="footer_error">
        <div class="container">
            <div class="footer_error_inner">
                <!--Navigation-->
                <div class="footer_error_navigation">
                    <!--Item-->
                    <a href='<?=PATH;?>' class="footer_error_navigation_link" tabindex="-2">
                        Идеи
                    </a>
                    <!--Item-->
                    <a href='/robot' class="footer_error_navigation_link" tabindex="-2">
                        Робот
                    </a>
                    <!--Item-->
                    <a href='/news' class="footer_error_navigation_link" tabindex="-2">
                        Новости
                    </a>
                    <!--Item-->
                    <a href='/calendar' class="footer_error_navigation_link" tabindex="-2">
                        Календарь
                    </a>
                    <!--Item-->
                    <a href='/help' class="footer_error_navigation_link" tabindex="-2">
                        Помощь
                    </a>
                </div>
                <!--Information-->
                <div class="footer_error_information">
                    <!--Text-->
                    <div class="footer_error_information_text">
                        © 2020,
                    ...
                    <!--Age Limit-->
                    <div class="footer_error_information_age_limit">
                        18+
                    </div>
                </div>
            </div>
...
<script src='/errors/prod/js/main.js'></script>
<script src='/errors/prod/js/app.js'></script>
</body>
</html>
