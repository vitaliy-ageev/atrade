...
<head>
    ...
    <!--Connect Styles-->
    <link rel="stylesheet" href="/errors/500/css/style.css">
    <link rel="stylesheet" href="./style/500/style.css">
...
<div class="page_500">
    ...
    <!--Footer-->
    <div class="footer_500">
        <div class="container">
            <div class="footer_500_inner">
                <!--Navigation-->
                <div class="footer_500_navigation">
                    <!--Item-->
                    <a href='<?=PATH;?>' class="footer_500_navigation_link" tabindex="-2">
                        Идеи
                    </a>
                    <!--Item-->
                    <a href='/robot' class="footer_500_navigation_link" tabindex="-2">
                        Робот
                    </a>
                    <!--Item-->
                    <a href='/news' class="footer_500_navigation_link" tabindex="-2">
                        Новости
                    </a>
                    <!--Item-->
                    <a href='/calendar' class="footer_500_navigation_link" tabindex="-2">
                        Календарь
                    </a>
                    <!--Item-->
                    <a href='/help' class="footer_500_navigation_link" tabindex="-2">
                        Помощь
                    </a>
                </div>
                <!--Information-->
                <div class="footer_500_information">
                    <!--Text-->
                    <div class="footer_500_information_text">
                        © 2020,
                    ...
                    <!--Age Limit-->
                    <div class="footer_500_information_age_limit">
                        18+
                    </div>
                </div>
            </div>
...
<script src='/errors/500/js/main.js'></script>
<script src='/errors/500/js/app.js'></script>
</body>
</html>
